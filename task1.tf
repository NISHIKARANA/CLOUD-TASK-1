...
// Executing commands to AMI Remotely
   ...
   provisioner "remote-exec" {
      inline = [
                 ...
                 "sudo git clone https://github.com/NISHIKARANA/CLOUD-TASK-1.git /var/www/html/"
              ]
        }
}
...
resource "aws_s3_bucket" "Task1s3bucket" {
    bucket = "task1-s3-bucket-nishika"
    acl = "public-read"
    region = "ap-south-1"
...
resource "aws_s3_bucket_object" "Task1imageupload" {
    ...
    key = "nishika.png"
    source = "C:/Users/Nishika/Downloads/terraform-task-1.jpg"
